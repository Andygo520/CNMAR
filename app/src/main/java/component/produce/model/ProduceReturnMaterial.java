...
/** 领料单退原料 */
public class ProduceReturnMaterial {
	...
	public ProduceReturnMaterial() {

	}

	public ProduceReturnMaterial(int receiveId, int materialId, int spaceId, int returnNum, int inOrderSpaceId) {
