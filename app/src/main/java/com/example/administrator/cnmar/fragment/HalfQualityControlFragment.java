...
import com.example.administrator.cnmar.activity.HalfQualityControlDetailActivity;
 ...
 */
public class HalfQualityControlFragment extends Fragment {
...
//                          当page等于总页数的时候，提示“加载完成”，不能继续上拉加载更多
                        if (page == total) {
                            String url = UniversalHelper.getTokenUrl(UrlHelper.URL_HALF_QC_LIST.replace("{page}", String.valueOf(page)));
                            getQCListFromNet(url);
        ...
        etSearchInput.setHint("子加工单编号查询");
            ...
            public boolean onKey(View v, int keyCode, KeyEvent event) {
                if (keyCode == KeyEvent.KEYCODE_ENTER && event.getAction() == KeyEvent.ACTION_UP) {
                    ...
                    if (input.equals("")) {
                        ...
                        String urlString = UniversalHelper.getTokenUrl(UrlHelper.URL_SEARCH_HALF_QC_LIST.replace("{query.code}", input));
...
//                偶数行背景设为灰色
            ...
            holder.tv1.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent intent = new Intent(context, HalfQualityControlDetailActivity.class);
