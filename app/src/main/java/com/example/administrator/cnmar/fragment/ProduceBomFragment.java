 ...
 */
public class ProduceBomFragment extends Fragment {
    ...
    private String strUrl = UniversalHelper.getTokenUrl(UrlHelper.URL_PRODUCE_BOM.replace("{page}", String.valueOf(page)));

    public ProduceBomFragment() {
...
//                            当page等于总页数的时候，提示“加载完成”，不能继续上拉加载更多
                        if (page == total) {
                            String url = UniversalHelper.getTokenUrl(UrlHelper.URL_PRODUCE_BOM.replace("{page}", String.valueOf(page)));
            ...
            public boolean onKey(View v, int keyCode, KeyEvent event) {
                if (keyCode == KeyEvent.KEYCODE_ENTER && event.getAction() == KeyEvent.ACTION_UP) {
                    ...
                    if (input.equals("")) {
                        ...
                        String urlString = UrlHelper.URL_SEARCH_PRODUCE_BOM.replace("{query.code}", input);
