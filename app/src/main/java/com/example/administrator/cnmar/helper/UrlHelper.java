...
//    public static String URL_IMAGE = "http://192.168.1.112:8090/";
    ...
    public static final String URL_SEARCH_RECEIVE_MATERIAL_ORDER = URL_BASE + "material_out_order_receive/list?query.code={query.code}&page.num=1";
    ...
    public static final String URL_PRODUCT_PRE_IN_STOCK_COMMIT = URL_BASE + "produce_plan/product_pre_in_stock_commit?producePlanId={ID}&successNum={successNum}";
    ...
    public static final String URL_HALF_PRODUCT_CHECK_COMMIT = URL_BASE + "half_stock_check_manage/check_commit?stockId={stockId}&spaceStockIds={spaceStockIds}&spaceIds={spaceIds}&beforeStocks={beforeStocks}&afterStocks={afterStocks}";
