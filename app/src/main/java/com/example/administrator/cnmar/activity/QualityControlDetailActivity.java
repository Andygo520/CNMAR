...
public class QualityControlDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvTitle.setText("品控管理-详情");

        llReturn= (LinearLayout) findViewById(R.id.left_arrow);
        llReturn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(QualityControlDetailActivity.this,QualityControlActivity.class);
...
//                不合格数量的非空判断
                if (map.size() < myAdapter.getCount()) {
                    Toast.makeText(QualityControlDetailActivity.this, "请输入不合格数量再提交", Toast.LENGTH_SHORT).show();
                    return;
                }
    ...
    public void getMaterialListFromNet(final String url) {
        new Thread(new Runnable() {
            @Override
            public void run() {
                RequestQueue quene = Volley.newRequestQueue(QualityControlDetailActivity.this);
                StringRequest stringRequest = new StringRequest(url, new Response.Listener<String>() {
                    ...
                    public void onResponse(String s) {
                        ...
                        myAdapter = new MaterialInfoAdapter(QualityControlDetailActivity.this, list);
