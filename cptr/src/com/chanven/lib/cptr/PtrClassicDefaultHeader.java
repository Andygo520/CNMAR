...
//    private TextView mLastUpdateTextView;
    ...
    private View ivRefreshImage,proRefreshProgressBar;
...
//        mProgressBar = (ImageView) header.findViewById(R.id.ptr_classic_header_rotate_view_progressbar);
        ...
        ivRefreshImage=findViewById(R.id.iv_refresh_image);
        proRefreshProgressBar=findViewById(R.id.pro_refresh_progressBar);
...
//        tryUpdateLastUpdateTime();
        ...
        ivRefreshImage.setVisibility(VISIBLE);//显示图片
        proRefreshProgressBar.setVisibility(INVISIBLE);//隐藏进度条
...
//        }
    ...
    public void onUIRefreshBegin(PtrFrameLayout frame) {
        ...
        proRefreshProgressBar.setVisibility(VISIBLE);//显示进度条

//        final AnimationDrawable frameAnim = (AnimationDrawable) getResources().getDrawable(R.drawable.refresh_image_anim);
//        mProgressBar.setBackgroundDrawable(frameAnim);// 把AnimationDrawable设置为ImageView的背景
//        frameAnim.start();
...
//        mProgressBar.clearAnimation();
        ...
        ivRefreshImage.setVisibility(INVISIBLE);
        proRefreshProgressBar.setVisibility(INVISIBLE);
